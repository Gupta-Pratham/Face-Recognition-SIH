...
class Student:
    def __init__(self,root):
        self.root = root
        self.root.geometry("1530x840+0+0")
        ...
        # First Image
        img = Image.open(r"C:\Users\Pratham Gupta\OneDrive\Desktop\Face Recognition System\college_images\face-recognition.png")
        ...
        # Second Image
        img1 = Image.open(r"C:\Users\Pratham Gupta\OneDrive\Desktop\Face Recognition System\college_images\smart-attendance.jpg")
        ...
        # Third Image
        img2 = Image.open(r"C:\Users\Pratham Gupta\OneDrive\Desktop\Face Recognition System\college_images\iStock-182059956_18390_t12.jpg")
        ...
        # Background Image
        img3 = Image.open(r"C:\Users\Pratham Gupta\OneDrive\Desktop\Face Recognition System\college_images\wp2551980.jpg")
        ...
        img_left = Image.open(r"C:\Users\Pratham Gupta\OneDrive\Desktop\Face Recognition System\college_images\AdobeStock_303989091.jpeg")
        ...
        dep_combo["values"] = ("Select Class","NURSERY","LKG","UKG","CLASS 1","CLASS 2","CLASS 3","CLASS 4","CLASS 5","CLASS 6",
        ...
        div_combo["values"] = ("Select the Division","A","B","C")
        div_combo.current(0)
        ...
        gender_combo["values"] = ("Select the Gender","Male","Female","Others")
        ...
        img_right = Image.open(r"C:\Users\Pratham Gupta\OneDrive\Desktop\Face Recognition System\college_images\gettyimages-1022573162.jpg")
        ...
        search_label = Label(search_frame,text="Search_By : ",font=("times new roman",13,"bold"),bg="red",fg="white")
    ...
    def add_data(self):
        if self.var_dep.get() == "Select Department" or self.var_std_id.get() == "" or self.var_std_name.get() == "":
            ...
            try:
                conn = mysql.connector.connect(host="localhost",username="root",password="Pratham@2603",database="face_recognizer")
                ...
                self.fetch_data()
                conn.close()
                messagebox.showinfo("Successs","Student details has een added successfully",parent=self.root)
...
#=================================== Generate Data Set or Take Photo Samples ========================================================================
    ...
    def generate_dataset(self):
        ...
        try:
            ...
            # Update current student record correctly
            my_cursor.execute("""
                UPDATE student SET
                    Dep=%s,
                    course=%s,
